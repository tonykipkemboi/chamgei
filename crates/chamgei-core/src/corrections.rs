...
//!
//! Tracks corrections the user makes after Chamgei injects text, analyses
...
pub struct CorrectionEntry {
    /// What Chamgei originally produced.
    pub original: String,
...
impl CorrectionLog {
    ...
    /// Return the default file path: `~/.config/chamgei/corrections.toml`.
...
pub struct CorrectionPattern {
    /// The text Chamgei originally produced.
...
mod tests {
    ...
    fn load_creates_missing_file() {
        let dir = std::env::temp_dir().join("chamgei-test-corrections");
